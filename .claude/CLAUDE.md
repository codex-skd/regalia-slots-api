# CLAUDE.md — regalia_slots_api (26.2)

Este repositorio es un mod NeoForge del grupo `stalking-dragons/minecraft`.

## Workflow del mod

1. **Trabaja con `docs/WORKFLOW_REGALIA_SLOTS_API_26-2.md`** — es el workflow operativo de este mod, autocontenido. Léelo y síguelo. No hay que actualizarlo por sesión.
...
3. Workflow del proyecto (`docs/WORKFLOW_REGALIA_SLOTS_API_26-2.md`).

...
<tr><td><code>top.theillusivec4.curios.api</code></td><td>Verbatim copy of the Curios 1.21.1 API, for binary compatibility with mods compiled against the real Curios.</td></tr>
...
<p>Regalia Slots API is a fork of <a href="https://www.curseforge.com/minecraft/mc-mods/curios">Curios API</a> by <strong>TheIllusiveC4</strong>, rebranded under a new mod id, package and assets. The <code>1.21.1</code> build is a re-fork from the upstream Curios 1.21.1 sources. All credit for the original design and implementation goes to the original author. Licensed <strong>LGPL-3.0-or-later</strong>, same as upstream; the full license text ships in the jar (<code>COPYING.LESSER</code>).</p>

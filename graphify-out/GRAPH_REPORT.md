# Graph Report - 26.2  (2026-08-28)

## Corpus Check
- 263 files · ~199,009 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3180 nodes · 7323 edges · 228 communities (169 shown, 59 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d90a7f6e`
...
Cohesion: 0.05
Nodes (38): BuildCreativeModeTabContentsEvent, HumanoidModel, HumanoidRender, ModelLayerLocation, RegisterLayerDefinitions, AmuletModel, HumanoidRenderState, LayerDefinition (+30 more)
...
Cohesion: 0.26
Nodes (8): IRegaliaSlotsApiCodecs, Attribute, Codec, Entry, Holder, Internal, RegistryFriendlyByteBuf, StreamCodec
...
Cohesion: 0.13
Nodes (13): CurioInventoryCapability, AttributeModifier, Identifier, IItemHandlerModifiable, ListTag, LivingEntity, Multimap, Nullable (+5 more)
...
Cohesion: 0.10
Nodes (21): Attribute, AttributeModifier, Component, CompoundTag, DamageSource, Deprecated, EnderMan, Holder (+13 more)
...
Cohesion: 0.18
Nodes (14): EntitiesData, EntitySlotEntry, Entry, Codec, Either, EntityType, ICondition, IEntitySlotEntry (+6 more)

### Community 23 - "Block Tags Provider"
Cohesion: 0.14
Nodes (16): BlockTagsProvider, DataProvider, Block, CachedOutput, Item, Nonnull, Override, PackOutput (+8 more)
...
Cohesion: 0.08
Nodes (13): Identifier, RegaliaTypeBridge, AttributeModifier, CompoundTag, DropRule, Identifier, IDynamicStackHandler, NonNullList (+5 more)
...
Cohesion: 0.20
Nodes (6): IItemHandlerModifiable, LivingEntity, IItemHandlerModifiable, Item, LivingEntity, Nullable
...
Cohesion: 0.30
Nodes (8): Attribute, Codec, Entry, Holder, Override, RegistryFriendlyByteBuf, StreamCodec, RegaliaSlotsApiCodecs
...
Cohesion: 0.10
Nodes (19): [0.0.0-beta.1] - 2026-08-19, [0.0.0-beta.2] - 2026-08-19, [0.0.0-beta.3] - 2026-08-19, [0.0.0-beta.4] - 2026-08-19, [1.0.0] - 2026-08-20, [1.1.0] - 2026-08-20, [1.1.1] - 2026-08-27, [1.1.2] - 2026-08-28 (+11 more)
...
Cohesion: 0.10
Nodes (5): ItemStack, Override, ValueInput, ValueOutput, RegaliaItemHandlerAdapter
...
Cohesion: 0.17
Nodes (13): BlockTagCopyingItemTagProvider, CuriosBlockTagsProvider, CuriosItemTagsProvider, Block, CachedOutput, Item, Nonnull, Override (+5 more)
...
Cohesion: 0.12
Nodes (11): CuriosResourceHandler, ItemResource, ItemStack, NullMarked, Override, IDynamicStackHandler, CompoundTag, Deprecated (+3 more)
...
Cohesion: 0.23
Nodes (11): CustomPacketPayload, CPacketToggleRender, Nonnull, Override, RegistryFriendlyByteBuf, StreamCodec, Nonnull, Override (+3 more)
...
Cohesion: 0.07
Nodes (24): LivingEvent, CurioCanEquipEvent, Deprecated, Internal, ItemStack, TriState, CurioCanUnequipEvent, Deprecated (+16 more)
...
Cohesion: 0.21
Nodes (5): ItemAccess, LivingEntity, Nullable, IRegaliaSlotsApiItemHandler, ServerPlayer
...
## Knowledge Gaps
- **117 isolated node(s):** `BACK`, `BELT`, `BODY`, `BRACELET`, `CHARM` (+112 more)
...
- **Why does `SlotContext` connect `Slot Context` to `Item Stack Handler`, `Humanoid Model Layers`, `Advancement Sub Providers`, `Curio Stack Operations`, `Item Properties`, `Regalia Slots API Item Handler`, `Block Drops Events`, `Itemized Regalia Slots API Capability`, `Player Avatar Rendering`, `Slot Type`, `Slot Item Handler`, `Container Menu Provider`, `Dynamic Operations`, `Amulet Item`, `Regalia Slots API Client Mod`, `CuriosCodecsAdapter.java`, `Equipment Slot Group`, `Regalia Slots API Slot Types`, `Recipe Book Screen`, `Entities Data`, `Regalia Slots API Tooltip`, `IEntitiesData Entry`, `Attribute Tooltip Events`, `CurioCanUnequipEvent`, `.getFortuneLevel`, `Curio Slot Extension`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `ISlotType` connect `Slot Type` to `Regalia Slots API Common Hooks`, `Attribute Handling`, `Item Properties`, `Regalia Slots API Item Handler`, `JSON Resource Reload`, `Block Drops Events`, `Slot Context`, `Slot Item Handler`, `SlotTypePredicate`, `Equipment Slot Group`, `SlotTypeAdapter`, `Regalia Slots API Slot Types`, `Recipe Book Screen`, `Entities Data`, `Regalia Slots API Tooltip`, `Attribute Tooltip Events`, `Damage and Drop Rules`, `Slot Overrides`, `Drop Rules`, `Regalia Slot API`, `Regalia GUI`, `Item Capabilities`, `ICurioSlotExtension`, `Sync Render Packet`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `SlotContext` connect `Data Generation` to `Curio Inventory`, `Network Services`, `Slot Context`, `CurioChangeEvent`, `CuriosServices.java`, `RegaliaSlotsApiDataComponents.java`, `ICurioSlotExtension`, `RegaliaSlotsApiTest.java`, `KnucklesModel`, `Loot Item Conditions`, `ICuriosSlots`, `SlotContext.java`, `Mod Event`, `ISlotType`, `Builder`, `SlotContext`?**
...
- **Should `Humanoid Model Layers` be split into smaller, more focused modules?**

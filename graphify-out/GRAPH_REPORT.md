...
## Corpus Check
- 260 files · ~198,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3128 nodes · 7172 edges · 218 communities (161 shown, 57 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d64d90d`
...
Cohesion: 0.38
Nodes (6): CrownRenderer, HumanoidModel, HumanoidRenderState, Identifier, ItemStack, Override

### Community 3 - "Server Reload Listeners"
Cohesion: 0.14
Nodes (12): AddServerReloadListenersEvent, FMLCommonSetupEvent, RegisterCommandsEvent, RegisterPayloadHandlersEvent, IEventBus, RegaliaSlotsApiIntegrations, IEventBus, ItemStack (+4 more)

### Community 4 - "Advancement Sub Providers"
Cohesion: 0.15
Nodes (12): AdvancementHolder, AdvancementSubProvider, ItemPredicate, Items, LocationPredicate, Criterion, CriterionTriggerInstance, Nonnull (+4 more)
...
Cohesion: 0.08
Nodes (26): Internal, RegaliaSlotsApiServices, IRegaliaSlotsApiCodecs, Attribute, Codec, Entry, Holder, Internal (+18 more)

### Community 8 - "Curio Stack Operations"
Cohesion: 0.15
Nodes (6): CurioStacksHandler, AttributeModifier, CompoundTag, Identifier, Operation, Override

### Community 9 - "Curio Inventory Capability"
Cohesion: 0.25
Nodes (6): CurioInventoryCapability, AttributeModifier, Identifier, Multimap, Operation, Override
...
Cohesion: 0.17
Nodes (12): ICurioRenderer, Deprecated, Item, RegaliaSlotsApiRendererRegistry, Internal, RegaliaSlotsApiClientServices, IRegaliaSlotsApiClientExtensions, Internal (+4 more)

### Community 12 - "Regalia Slots API Item Handler"
Cohesion: 0.23
Nodes (6): ItemAccess, ItemStack, Nullable, SlotResult, Item, ItemStack
...
Cohesion: 0.11
Nodes (5): ISlotData, Internal, Override, Provider, SlotData
...
Cohesion: 0.14
Nodes (21): HumanoidRender, AbstractClientPlayer, AvatarRenderState, Context, Deprecated, EntityModel, HumanoidArm, HumanoidRenderState (+13 more)
...
Cohesion: 0.12
Nodes (17): BlockTagCopyingItemTagProvider, BlockTagsProvider, DataProvider, Block, CachedOutput, Item, Nonnull, Override (+9 more)

### Community 24 - "Command Build Context"
Cohesion: 0.13
Nodes (16): ArgumentType, CommandBuildContext, CommandContext, CommandDispatcher, DynamicCommandExceptionType, ItemInput, CurioArgumentType, CommandSourceStack (+8 more)

### Community 25 - "Level and Entity Slots"
Cohesion: 0.15
Nodes (6): IDynamicStackHandler, CompoundTag, Deprecated, ItemStack, Nonnull, Provider

### Community 26 - "Slot Item Handler"
Cohesion: 0.05
Nodes (31): Accessor, OnPress, SlotItemHandler, ICurioSlotExtension, Component, Deprecated, ItemStack, TooltipFlag (+23 more)
...
Cohesion: 0.13
Nodes (15): AbstractContainerScreen, Pre, FMLClientSetupEvent, GuiGraphicsExtractor, Override, WidgetSprites, RegaliaSlotsApiButton, Post (+7 more)
...
Cohesion: 0.08
Nodes (24): AbstractRecipeBookScreen, EffectsInInventory, IGuiContainerHandler, ItemSlotMouseAction, KeyEvent, MouseButtonEvent, RecipeUpdateListener, ScreenPosition (+16 more)
...
Cohesion: 0.08
Nodes (32): CustomPacketPayload, PayloadRegistrar, IPayloadContext, RegaliaSlotsApiClientPayloadHandler, NetworkHandler, Nonnull, Override, RegistryFriendlyByteBuf (+24 more)
...
Cohesion: 0.19
Nodes (12): Cache, IAttachmentHolder, CurioInventory, Identifier, ItemStack, LivingEntity, NonNullList, Override (+4 more)
...
Cohesion: 0.25
Nodes (11): ContextAwarePredicate, SimpleCriterionTrigger, SimpleInstance, EquipCurioTrigger, Codec, ItemStack, LootContext, Nonnull (+3 more)
...
Cohesion: 0.21
Nodes (5): IItemHandlerModifiable, Item, ItemStack, LootContext, SlotResult

### Community 60 - "Preset Slots"
Cohesion: 0.17
Nodes (7): ItemStackHandler, ListTag, LivingEntity, Nullable, Tag, ValueInput, ValueOutput
...
Cohesion: 0.14
Nodes (8): IItemHandlerModifiable, LivingEntity, IItemHandlerModifiable, Item, LivingEntity, Nullable, ValueInput, ValueOutput
...
Cohesion: 0.17
Nodes (11): ImageButton, CosmeticButton, GuiGraphicsExtractor, Override, WidgetSprites, IRegaliaSlotsApiWidget, CPacketToggleCosmetics, Nonnull (+3 more)
...
Cohesion: 0.19
Nodes (8): IRegaliaSlotsApiMenu, RegaliaSlotsApiClientPackets, Nonnull, Override, RegistryFriendlyByteBuf, ServerPlayer, StreamCodec, SPacketSyncData
...
Cohesion: 0.29
Nodes (9): ArgumentTypeInfo, CriterionTrigger, MenuType, AttachmentType, DataComponentType, DeferredRegister, IEventBus, Override (+1 more)
...
Cohesion: 0.21
Nodes (8): Multimap, NonNullList, ValueInput, ValueOutput, AttachmentType, DeferredRegister, IEventBus, LegacyCurioMigration
...
Cohesion: 0.12
Nodes (15): [0.0.0-beta.1] - 2026-08-19, [0.0.0-beta.2] - 2026-08-19, [0.0.0-beta.3] - 2026-08-19, [0.0.0-beta.4] - 2026-08-19, [1.0.0] - 2026-08-20, [1.1.0] - 2026-08-20, Añadido, Añadido (+7 more)
...
Cohesion: 0.10
Nodes (6): Deprecated, Tag, CuriosItemHandlerAdapter, ItemStack, Override, Tag
...
Cohesion: 0.42
Nodes (8): Entry, Either, EntityType, ICondition, Identifier, JsonObject, ResourceKey, TagKey
...
Cohesion: 0.22
Nodes (8): HumanoidModel, AmuletModel, HumanoidRenderState, LayerDefinition, ModelPart, CrownModel, LayerDefinition, ModelPart
...
Cohesion: 0.36
Nodes (7): HumanoidRender, HumanoidModel, HumanoidRenderState, Identifier, ItemStack, Override, KnucklesRenderer
...
Cohesion: 0.22
Nodes (9): PlayerLoggedInEvent, CuriosCompatMod, CurioAttributeModifiers, DataComponentType, DeferredRegister, IEventBus, Mod, ModContainer (+1 more)
...
Cohesion: 0.17
Nodes (4): IRegaliaSlotsApiItemHandler, LootContext, LootContext, ServerPlayer
...
## Knowledge Gaps
- **115 isolated node(s):** `BACK`, `BELT`, `BODY`, `BRACELET`, `CHARM` (+110 more)
...
- **Why does `SlotContext` connect `Slot Context` to `Regalia Slots API Common Hooks`, `Item Stack Handler`, `Humanoid Model Layers`, `Curio Stack Operations`, `Item Properties`, `Regalia Slots API Item Handler`, `Block Drops Events`, `Itemized Regalia Slots API Capability`, `Player Avatar Rendering`, `Regalia Slots API Renderer`, `Slot Type`, `Slot Item Handler`, `Container Menu Provider`, `Dynamic Operations`, `Amulet Item`, `Regalia Slots API Client Mod`, `Equipment Slot Group`, `Regalia Slots API Slot Types`, `Curio Argument Type`, `Entities Data`, `Regalia Slots API Tooltip`, `IEntitiesData Entry`, `Attribute Tooltip Events`, `KnucklesRenderer.java`, `CurioCanUnequipEvent`, `Regalia Resources`, `Regalia Slot API`, `Curio Slot Extension`, `Slot Context`, `Internal Build Methods`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `ISlotType` connect `Slot Type` to `Regalia Slots API Common Hooks`, `Attribute Handling`, `Item Properties`, `Regalia Slots API Item Handler`, `JSON Resource Reload`, `Block Drops Events`, `Slot Context`, `Command Build Context`, `Slot Item Handler`, `Equipment Slot Group`, `SlotTypeAdapter`, `Regalia Slots API Slot Types`, `Recipe Book Screen`, `Entities Data`, `Regalia Slots API Tooltip`, `Attribute Tooltip Events`, `Damage and Drop Rules`, `Slot Overrides`, `Drop Rules`, `.getSlotType`, `Item Capabilities`?**

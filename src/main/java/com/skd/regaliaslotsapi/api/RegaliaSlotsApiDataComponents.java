...
/**
 * Data components for RegaliaSlotsApi items and objects.
 */
public final class RegaliaSlotsApiDataComponents {

  public static final DataComponentType<CurioAttributeModifiers> ATTRIBUTE_MODIFIERS =
      RegaliaSlotsApiServices.REGISTRY.getAttributeModifierComponent();

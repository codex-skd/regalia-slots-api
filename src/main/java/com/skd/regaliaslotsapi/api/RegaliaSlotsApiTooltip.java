...
/**
 * Helper class for building tooltips in a unified style with RegaliaSlotsApi
 */
...
public class RegaliaSlotsApiTooltip {
  ...
  public List<Component> build() {
    ...
    if (!this.identifiers.isEmpty()) {
      ...
      Map<String, ISlotType> map = RegaliaSlotsApiSlotTypes.getItemSlotTypes(this.stack, this.livingEntity);

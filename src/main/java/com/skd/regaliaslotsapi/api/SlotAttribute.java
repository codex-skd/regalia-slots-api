...
public class SlotAttribute extends Attribute {
  ...
  public Identifier resourceLocation() {
    return RegaliaSlotsApiResources.resource(this.getIdentifier());
  }
  ...
  public static final Codec<Holder<Attribute>> CODEC = RegaliaSlotsApiServices.CODECS.slotAttributeCodec();
  public static final StreamCodec<RegistryFriendlyByteBuf, Holder<Attribute>> STREAM_CODEC =
      RegaliaSlotsApiServices.CODECS.slotAttributeStreamCodec();
}

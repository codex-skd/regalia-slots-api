...
package com.skd.regaliaslotsapi.api.client;
...
import com.skd.regaliaslotsapi.api.internal.RegaliaSlotsApiClientServices;
...
public interface ICurioRenderer {
  ...
  static void register(Item item, Supplier<ICurioRenderer> curioRenderer) {
    RegaliaSlotsApiClientServices.EXTENSIONS.registerCurioRenderer(item, curioRenderer);
  }
  ...
  static ICurioRenderer get(Item item) {
    ICurioRenderer renderer = RegaliaSlotsApiClientServices.EXTENSIONS.getCurioRenderer(item);
  ...
  static ICurioRenderer getOrNull(Item item) {
    return RegaliaSlotsApiClientServices.EXTENSIONS.getCurioRenderer(item);
  }

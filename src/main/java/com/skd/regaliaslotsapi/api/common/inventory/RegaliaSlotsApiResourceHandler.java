package com.skd.regaliaslotsapi.api.common.inventory;
...
@NullMarked
public class RegaliaSlotsApiResourceHandler extends ItemStacksResourceHandler {

  final IDynamicStackHandler curioStacks;

  public RegaliaSlotsApiResourceHandler(IDynamicStackHandler curioStacks) {

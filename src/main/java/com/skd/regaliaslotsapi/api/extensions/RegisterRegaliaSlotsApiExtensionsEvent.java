package com.skd.regaliaslotsapi.api.extensions;
...
/**
 * Allows registration of new behavior to various game objects used by RegaliaSlotsApi. Fired during {@link
 * net.neoforged.fml.event.lifecycle.FMLCommonSetupEvent} on the mod-specific event bus.
 */
public class RegisterRegaliaSlotsApiExtensionsEvent extends Event implements IModBusEvent {
  ...
  public void registerSlotExtension(@Nonnull ICurioSlotExtension extension, String... slotIds) {
    RegaliaSlotsApiServices.EXTENSIONS.registerSlotExtension(extension, slotIds);
  }
  ...
  public boolean isSlotExtensionRegistered(String slotId) {
    return RegaliaSlotsApiServices.EXTENSIONS.getSlotExtension(slotId) != null;
  }
}

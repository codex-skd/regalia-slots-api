...
package com.skd.regaliaslotsapi.api.type.util;
...
public interface ISlotHelper {
  ...
  /**
   * @deprecated See {@link com.skd.regaliaslotsapi.api.type.capability.ICuriosItemHandler#getCurios()}
   */
  @Deprecated(forRemoval = true, since = "1.20.1")
  @ApiStatus.ScheduledForRemoval(inVersion = "1.22")
  ...
  /**
   * @deprecated See {@link com.skd.regaliaslotsapi.api.type.capability.ICuriosItemHandler#addTransientSlotModifiers(Multimap)}

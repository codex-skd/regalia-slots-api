...
public class RegaliaSlotsApiButton extends ImageButton {
  ...
  public static final WidgetSprites BIG =
      new WidgetSprites(ResourceLocation.fromNamespaceAndPath(RegaliaSlotsApi.MODID, "button"),
          ResourceLocation.fromNamespaceAndPath(RegaliaSlotsApi.MODID, "button_highlighted"));
  public static final WidgetSprites SMALL =
      new WidgetSprites(ResourceLocation.fromNamespaceAndPath(RegaliaSlotsApi.MODID, "button_small"),
          ResourceLocation.fromNamespaceAndPath(RegaliaSlotsApi.MODID, "button_small_highlighted"));
  private final AbstractContainerScreen<?> parentGui;

  RegaliaSlotsApiButton(AbstractContainerScreen<?> parentGui, int xIn, int yIn, int widthIn, int heightIn,

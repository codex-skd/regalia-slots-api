...
public class EntitiesData implements IEntitiesData {
  ...
  public IEntitiesData addPlayer() {
    return addEntities(RegaliaSlotsApiTags.PLAYER_LIKE);
  }
  ...
  public IEntitiesData addAllPresetSlots() {
    return this.addSlots(Arrays.stream(RegaliaSlotsApiSlotTypes.Preset.values())
                             .map(RegaliaSlotsApiSlotTypes.Preset::id)
                             .toArray(String[]::new));
  }

  @Override
  public IEntitiesData addAllPresetSlotsExcept(RegaliaSlotsApiSlotTypes.Preset... presets) {
    return this.addSlots(Arrays.stream(RegaliaSlotsApiSlotTypes.Preset.values())
  ...
  @Override
  public IEntitiesData addPresetSlots(RegaliaSlotsApiSlotTypes.Preset... preset) {

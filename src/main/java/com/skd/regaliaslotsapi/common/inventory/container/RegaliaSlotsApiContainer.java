...
public class RegaliaSlotsApiContainer extends RecipeBookMenu<RecipeInput, Recipe<RecipeInput>>
  ...
  public RegaliaSlotsApiContainer(int windowId, Inventory playerInventory, FriendlyByteBuf packetBuffer) {
    this(windowId, playerInventory);
  }

  public RegaliaSlotsApiContainer(int windowId, Inventory playerInventory) {
    super(RegaliaSlotsApiRegistry.CURIO_MENU.get(), windowId);
    ...
    for (int k = 0; k < 4; ++k) {
      ...
      this.addSlot(new Slot(player.getInventory(), 36 + (3 - k), 8, 8 + k * 18) {
        ...
        public void set(@Nonnull ItemStack stack) {
          ...
          super.set(stack);
          RegaliaSlotsApiContainer.this.player.onEquipItem(equipmentslottype, itemstack, stack);
        }
        ...
        public boolean mayPlace(@Nonnull ItemStack stack) {
          return stack.canEquip(equipmentslottype, RegaliaSlotsApiContainer.this.player);
        }
    ...
    if (slot.hasItem()) {
      ...
      if (index == 0) {
        ...
        if (!this.moveItemStackTo(itemstack1, i, i + 1, false)) {
          ...
          !RegaliaSlotsApi.getItemStackSlots(itemstack, playerIn.level()).isEmpty()) {

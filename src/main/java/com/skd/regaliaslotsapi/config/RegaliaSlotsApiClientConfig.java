...
public class RegaliaSlotsApiClientConfig {

  public static final ModConfigSpec CLIENT_SPEC;
  public static final Client CLIENT;
  private static final String CONFIG_PREFIX = "gui." + RegaliaSlotsApiConstants.MOD_ID + ".config.";
  ...
  public static class Client {
    ...
    public final ModConfigSpec.BooleanValue renderRegaliaSlotsApi;
    ...
    Client(ModConfigSpec.Builder builder) {
      ...
      renderRegaliaSlotsApi = builder.comment("Set to true to enable rendering curios")
          .translation(CONFIG_PREFIX + "renderRegaliaSlotsApi").define("renderRegaliaSlotsApi", true);
      enableButton = builder.comment("Set to true to enable the RegaliaSlotsApi GUI button")
          .translation(CONFIG_PREFIX + "enableButton").define("enableButton", true);
      buttonXOffset = builder.comment("The X-Offset for the RegaliaSlotsApi GUI button")
          .translation(CONFIG_PREFIX + "buttonXOffset")
          .defineInRange("buttonXOffset", 0, -100, 100);
      buttonYOffset = builder.comment("The Y-Offset for the RegaliaSlotsApi GUI button")
          .translation(CONFIG_PREFIX + "buttonYOffset")
          .defineInRange("buttonYOffset", 0, -100, 100);
      creativeButtonXOffset = builder.comment("The X-Offset for the Creative RegaliaSlotsApi GUI button")
          .translation(CONFIG_PREFIX + "creativeButtonXOffset")
          .defineInRange("creativeButtonXOffset", 0, -100, 100);
      creativeButtonYOffset = builder.comment("The Y-Offset for the Creative RegaliaSlotsApi GUI button")
          .translation(CONFIG_PREFIX + "creativeButtonYOffset")
          .defineInRange("creativeButtonYOffset", 0, -100, 100);
      buttonCorner = builder.comment("The corner for the RegaliaSlotsApi GUI button")

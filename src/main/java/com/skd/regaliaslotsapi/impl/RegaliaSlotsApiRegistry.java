...
public class RegaliaSlotsApiRegistry implements IRegaliaSlotsApiRegistry {

  private static final DeferredRegister<AttachmentType<?>> ATTACHMENT_TYPES =
      DeferredRegister.create(
          NeoForgeRegistries.Keys.ATTACHMENT_TYPES, RegaliaSlotsApiResources.MOD_ID);
  private static final DeferredRegister<CriterionTrigger<?>> CRITERION_TRIGGERS =
      DeferredRegister.create(Registries.TRIGGER_TYPE, RegaliaSlotsApiResources.MOD_ID);
  private static final DeferredRegister<ArgumentTypeInfo<?, ?>> ARGUMENT_TYPES =
      DeferredRegister.create(Registries.COMMAND_ARGUMENT_TYPE, RegaliaSlotsApiResources.MOD_ID);
  private static final DeferredRegister<MenuType<?>> MENU_TYPES =
      DeferredRegister.create(Registries.MENU, RegaliaSlotsApiResources.MOD_ID);
  private static final DeferredRegister<DataComponentType<?>> DATA_COMPONENTS =
      DeferredRegister.createDataComponents(Registries.DATA_COMPONENT_TYPE, RegaliaSlotsApiResources.MOD_ID);
  ...
  public static final Supplier<MenuType<RegaliaSlotsApiMenu>> CURIO_MENU =
      MENU_TYPES.register("curios_container",
                          () -> IMenuTypeExtension.create(RegaliaSlotsApiMenu::new));
